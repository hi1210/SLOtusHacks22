...
const original =
    (_a = document.querySelector('.purchase')) === null || _a === void 0
        ? void 0
        : _a.querySelector('p');
const round1 =
    (_b = document.querySelector('.donation')) === null || _b === void 0
        ? void 0
        : _b.querySelector('#round-one-button');
const round10 =
    (_c = document.querySelector('.donation')) === null || _c === void 0
        ? void 0
        : _c.querySelector('#round-ten-button');
const round1text = document.querySelector('#round-dollar');
const round10text = document.querySelector('#round-ten');
const totalamt =
    (_d = document.querySelector('.total')) === null || _d === void 0
        ? void 0
        : _d.querySelector('p');
const submit = document.querySelector('a.submit-button');
